...
// Instead of the custom generateDemoReport, use the main report generator for full report
const mainReport = require('../scripts/generate-report.js');
const outputDir = __dirname;
mainReport.generateDetailedReport(metrics, 'Demo S3 Endpoint Test Results', outputDir);
console.log('Full-featured demo report generated at', path.join(outputDir, 'index.html'));

// The following code is no longer needed and has been removed:
